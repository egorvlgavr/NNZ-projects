...
${OBJECTDIR}/ImageSaver.o: ImageSaver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/opencv -I../../../../src/boost_1_60_0 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ImageSaver.o ImageSaver.cpp
...
${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/local/include/opencv -I../../../../src/boost_1_60_0 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
